...
class Funcionario(models.Model):
    ...
    fun_nome = models.CharField(max_length=255, verbose_name="Nome do Funcionário", null=False, blank=False)
    fun_aniversario = models.DateField(verbose_name="Data de Aniversário", null=True, blank=True)
    fun_senha = models.CharField(max_length=255, verbose_name="Senha", null=True, blank=True)
    fun_telefone = models.CharField(max_length=20, verbose_name="Telefone", null=True, blank=True)
    fun_email = models.EmailField(verbose_name="E-mail", unique=True, null=True, blank=True)
    fun_cpf = models.CharField(max_length=14, verbose_name="CPF", unique=True, null=True, blank=True)

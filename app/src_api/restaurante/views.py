...
#         """
#         novo_status = request.data.get("ped_status")
#         if not novo_status:
#             return Response({"error": "O campo 'ped_status' é obrigatório."}, status=status.HTTP_400_BAD_REQUEST)
        
#         pedido = self.get_object()
#         pedido.ped_status = novo_status
#         pedido.save()
